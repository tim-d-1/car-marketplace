...
class WishlistTests(TestCase):
    def setUp(self):
        ...
        self.car1 = Car.objects.create(
            brand='Toyota', model='Camry', year=2020, price=15000, 
            description='Good condition', condition='used'
        )
        self.car2 = Car.objects.create(
            brand='Honda', model='Civic', year=2021, price=18000, 
            description='Great condition', condition='used'
        )
    ...
    def test_toggle_wishlist_remove(self):
        ...
        self.assertFalse(Wishlist.objects.filter(user=self.user, car=self.car1).exists())
